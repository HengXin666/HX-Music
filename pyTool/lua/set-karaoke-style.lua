...
-- CLI 使用该接口
-- @by Heng_Xin
-- @todo 不应该显示在 GUI 中, 日后再调整吧qwq...
-- @todo 暂时不清楚怎么通过命令行传参.. 只能写死了
function macro_set_style_cli(subs, sel)
    local handle_style = "orig"
    local advance_time = 100
    local sep_threshold = 2000
    
    set_style(subs, handle_style, advance_time, sep_threshold)
